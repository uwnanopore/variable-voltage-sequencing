function [trained_classifier, validation_accuracy] = trainRemovalClassifierQuadSVM(training_data)
...
input_table.X_train_7 = input_table.X_train(:, 7);
input_table.X_train_8 = input_table.X_train(:, 8);
input_table.X_train_9 = input_table.X_train(:, 9);
input_table.X_train_10 = input_table.X_train(:, 10);
input_table.X_train_11 = input_table.X_train(:, 11);
input_table.X_train_12 = input_table.X_train(:, 12);

predictor_names = {'X_train_1', 'X_train_2', 'X_train_3', 'X_train_4', 'X_train_5', 'X_train_6', ...
    'X_train_7', 'X_train_8', 'X_train_9', 'X_train_10', 'X_train_11', 'X_train_12'};
predictors = input_table(:, predictor_names);
response = input_table.y_train;
is_categorical_predictor = [false, false, false, false, false, false, false, false, false, false, false, false];
